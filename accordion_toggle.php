...
<!-- animate CSS  -->
<link rel="stylesheet" type="text/css" href="css/animate.css" media="all"><!-- jquery-ui.min CSS  -->
...
<div id="page"> 
      ...
      <div class="row">
        <div class="mtmegamenu">
          <ul>
            ...
            <li class="mt-root">
              <div class="mt-root-item"><a href="#" class="active">
                ...
                <li class="menu-item depth-1 product menucol-1-4 withimage">
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      <div class="icon-sale-label sale-left">Sale</div>
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="images/products/img18.jpg" alt=""> <img class="hover-img" src="images/products/img18.jpg" alt="">
                          <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="home"> <a title="Go to Home Page" href="#">Elements </a><span>&raquo;</span></li>
            <li class="category13"><strong>Accordion &amp; Toggle</strong></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <!-- Main Container -->
  <section class="shortcodes-wrapper bounceInUp animated">
    <div class="container">
      <div class="row">
      <div class="page-title">
        ...
        <div class="col-md-6 col-xs-12">
          <div id="st-accordion" class="st-accordion">
            <ul>
              <li> <a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit<span class="st-arrow"><i class="fa fa-caret-down"></i></span></a>
                <div class="st-content">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elitss ed do eiusmod tempor incididun ut labore et dolore mag na aliqua. Utes enim ad minim veniam, quis nostrud exerck itation ullam co laboris nisi ut aliquip ex ea commodo coes nsequat. Lorem ipsum dolor sit amet, consectst etur adipisicing elitss ed do eiusmod tempor incididunt ut labore et dolore magn aliqua. Utes enim ad minim veniam, quis nostrud exerck itation ullam co laboris nisi ut aliquip ex ea commodo coes nsequat. </p>
                  <br />
                  <ul class="accordion-img">
                    <li> <img src="images/products/img01.jpg" alt="" /></li>
                    <li> <img src="images/products/img06.jpg" alt=""  /></li>
                    <li> <img src="images/products/img11.jpg" alt="" /> </li>
                    <li><img src="images/products/img15.jpg" alt="" /></li>
                  </ul>
                </div>
              </li>
              <li> <a href="#">Excepteur sint occaecat cupidatat non proident<span class="st-arrow"><i class="fa fa-caret-down"></i></span></a>
                <div class="st-content">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus in nisi ut nulla iaculs trist iq ue in vitae nibh. Phasellus ac nisl vel erat mollis aliquam. </p>
                  <br />
              ...
              <li> <a href="#"> Duis aute irure dolor in reprehenderit in voluptate velit<span class="st-arrow"><i class="fa fa-caret-down"></i></span></a>
                <div class="st-content">
                  <p>Curabitur sed sem at eros porttids tor. Cura bitur sed sem at eros portCurabitur sed sem at eros portt. Curabitur sed ses sat eros porttids tor. Curabitur sed ses sat eros porttids tor</p>
                </div>
              </li>
              <li> <a href="#">Quisque semper est neque. Maecenas dapibus est eu purus<span class="st-arrow"><i class="fa fa-caret-down"></i></span></a>
                <div class="st-content">
              ...
              <li> <a href="#">Curabitur vestibulum, turpis ac convallis pharetra, lorem ante<span class="st-arrow"><i class="fa fa-caret-down"></i></span></a>
                <div class="st-content">
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries the leap into typesettings.</p>
                </div>
              </li>
              <li> <a href="#">Lorem Ipsum has been the industry’s standard dummy text<span class="st-arrow"><i class="fa fa-caret-down"></i></span></a>
                <div class="st-content">
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries the leap into typesettings.</p>
                </div>
              </li>
        ...
        <div class="col-md-6 col-xs-12">
          <div id="st-accordion-four" class="st-accordion-four">
            <ul>
              <li> <a href="#">Lorem Ipsum is simply dummy text of the printing<span class="st-arrow"> </span></a>
                <div class="st-content">
                  <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
              </li>
              <li> <a href="#">Quisque suscipit ut urna at maximus. Sed euismod<span class="st-arrow"> </span></a>
                <div class="st-content">
              ...
              <li> <a href="#">Duis aute irure dolor in reprehenderit in voluptate<span class="st-arrow"> </span></a>
                <div class="st-content">
                  <p>All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always.</p>
                </div>
              </li>
              <li> <a href="#">Necessitatibus possimus libero similique ut eum explicabo<span class="st-arrow"> </span></a>
                <div class="st-content">
        ...
        <div class="row">
          <div class="col-md-6 col-xs-12">
            <div id="st-accordion-three" class="st-accordion-two">
              <ul>
                <li> <a href="#">Donec leo velit, tincidunt adipiscing aliquet id, blandit vel lacus<span class="st-arrow"> </span></a>
                  <div class="st-content">
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there anything hidden in the middle of text repeat predefined chunks as necessary, making this the first true generator on the Internet.</p>
                  </div>
                </li>
                <li> <a href="#">Quisque suscipit ut urna at maximus. Sed euismod<span class="st-arrow"> </span></a>
                  <div class="st-content">
          ...
          <div class="col-md-6 col-xs-12"> <img src="images/about_us_slide1.jpg" alt=""/> </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6 col-xs-12">
          <div id="st-accordion-five" class="st-accordion-five">
            <ul>
              <li> <a href="#">Donec leo velit, tincidunt adipiscing aliquet id, blandit vel lacus<span class="st-arrow"><i class="fa fa-angle-down"></i></span></a>
                <div class="st-content">
                  <p>She packed her seven versalia, put her into the belt and made on the way.</p>
                  <p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her she had a last view back on the skyline of her  hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane.</p>
                </div>
              </li>
              <li> <a href="#">Quisque suscipit ut urna at maximus. Sed euismod<span class="st-arrow"><i class="fa fa-angle-down"></i></span></a>
                <div class="st-content">
                  <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
                  <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
                </div>
              </li>
              <li> <a href="#">Duis aute irure dolor in reprehenderit in voluptate<span class="st-arrow"><i class="fa fa-angle-down"></i></span></a>
                <div class="st-content">
              ...
              <li> <a href="#">Necessitatibus possimus libero similique ut eum explicabo<span class="st-arrow"><i class="fa fa-angle-down"></i></span></a>
                <div class="st-content">
        ...
        <div class="col-md-6 col-xs-12">
          <div id="st-accordion-two" class="st-accordion">
            <ul>
              <li> <a href="#">Donec leo velit, tincidunt adipiscing aliquet id, blandit vel lacus<span class="st-arrow"><i class="fa fa-angle-double-down"></i></span></a>
                <div class="st-content">
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle text all the Lorem Ipsum generators on the Internet to repeat predefined. </p>
                  <br />
                  <ul class="accordion-img">
                    <li> <img src="images/products/img01.jpg" alt="" /></li>
                    <li> <img src="images/products/img06.jpg" alt=""  /></li>
              ...
              <li> <a href="#">Quisque suscipit ut urna at maximus. Sed euismod<span class="st-arrow"><i class="fa fa-angle-double-down"></i></span></a>
                <div class="st-content">
              ...
              <li> <a href="#">Duis aute irure dolor in reprehenderit in voluptate<span class="st-arrow"><i class="fa fa-angle-double-down"></i></span></a>
                <div class="st-content">
                  <p> The has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions.</p>
                </div>
              </li>
              <li> <a href="#">Necessitatibus possimus libero similique ut eum explicabo<span class="st-arrow"><i class="fa fa-angle-double-down"></i></span></a>
                <div class="st-content">
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries the leap into typesettings.</p>
                </div>
              </li>
              <li> <a href="#">Phasellus luctus neque nec ipsum facilisis in dignissim<span class="st-arrow"><i class="fa fa-angle-double-down"></i></span></a>
                <div class="st-content">
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries the leap into typesettings.</p>
                </div>
              </li>
              <li> <a href="#">Lorem Ipsum is simply dummy text of the printing<span class="st-arrow"><i class="fa fa-angle-double-down"></i></span></a>
                <div class="st-content">
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries the leap into typesettings.</p>
                </div>
              </li>
