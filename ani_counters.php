      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Animated Counters</strong></li>
          </ul>
        </div>
      </div>
    </div>
...
<section class="shortcodes-wrapper bounceInUp animated">
  <div class="container">
    ...
    <div class="col-xs-12">
    <div class="counters1">
        <div class="one_fifth col-md-3 col-xs-6"> <span id="target">0</span>
          <h4>Projects</h4>
        </div>
        <div class="one_fifth col-md-3 col-xs-6"> <span id="target2">0</span>
          <h4>Clients</h4>
        </div>
        <div class="one_fifth col-md-3 col-xs-6"> <span id="target3">0</span>
          <h4>Awards</h4>
        </div>
        <div class="one_fifth col-md-3 col-xs-6"> <span id="target4">0</span>
          <h4>Likes</h4>
        </div>
        <div class="one_fifth col-md-3 col-xs-6"> <span id="target5">0</span>
          <h4>Days</h4>
        </div>
      </div>
  ...
  <div class="col-xs-12">
  <div class="counters2">
        <div class="one_fourth col-md-3 col-sm-6 col-xs-6"> <i class="fa fa-cogs"></i> <span id="target6"> 0</span>
          <h4>Projects</h4>
        </div>
        <div class="one_fourth col-md-3 col-sm-6 col-xs-6"> <i class="fa fa-umbrella"></i> <span id="target7"> 0</span>
          <h4>Clients</h4>
        </div>
        <div class="one_fourth col-md-3 col-sm-6 col-xs-6"> <i class="fa fa-trophy"></i> <span id="target8"> 0</span>
          <h4>Awards</h4>
        </div>
        <div class="one_fourth col-md-3 col-sm-6 col-xs-6"> <i class="fa fa-heart"></i> <span id="target9"> 0</span>
          <h4>Likes</h4>
        </div>
      </div>
  </div> 
  <div class="col-xs-12">
     <div class="counters4"> <span id="target14"> 0 </span> + Happy Clients
        <h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h4>
      </div>
     </div>
    <div class="col-xs-12">
    <div class="counters3">
        <div class="one_fourth one col-md-3 col-sm-6 col-xs-6"> <i class="fa fa-cogs"></i> <span id="target10"> 0</span>
          <h4>Projects</h4>
        </div>
        <div class="one_fourth two col-md-3 col-sm-6 col-xs-6"> <i class="fa fa-umbrella"></i> <span id="target11"> 0</span>
          <h4>Clients</h4>
        </div>
        <div class="one_fourth three col-md-3 col-sm-6 col-xs-6"> <i class="fa fa-trophy"></i> <span id="target12"> 0</span>
          <h4>Awards</h4>
        </div>
        <div class="one_fourth four col-md-3 col-sm-6 col-xs-6"> <i class="fa fa-heart"></i> <span id="target13"> 0</span>
          <h4>Likes</h4>
        </div>
      </div>
    </div>  
