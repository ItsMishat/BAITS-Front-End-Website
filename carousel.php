...
<!-- owl carousel -->
<link href="css/cowl.carousel.css" rel="stylesheet">
</head>

<body class="carousel_slider">
<!-- mobile menu -->
<div id="mobile-menu">
  <ul>
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Carousel Sliders</strong></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="stcode_title4">
            <h3><span class="line"></span><span class="text"><strong>Auto Play</strong><span></span></span></h3>
          </div>
          <div id="owl-demo" class="owl-carousel">
            <div class="item"><img src="images/img01.jpg" alt="" /></div>
            <div class="item"><img src="images/img02.jpg" alt="" /></div>
            <div class="item"><img src="images/img03.jpg" alt="" /></div>
            <div class="item"><img src="images/img04.jpg" alt="" /></div>
            <div class="item"><img src="images/img05.jpg" alt="" /></div>
            <div class="item"><img src="images/img06.jpg" alt="" /></div>
            <div class="item"><img src="images/img07.jpg" alt="" /></div>
            <div class="item"><img src="images/img08.jpg" alt="" /></div>
          </div>
          <!-- end section -->
          ...
          <div class="stcode_title4">
            <h3><span class="line"></span><span class="text"><strong>Auto Height</strong><span></span></span></h3>
          </div>
          <div class="margin_top1"></div>
          <div class="clearfix"></div>
          <div id="owl-demo2" class="owl-carousel">
            <div><img src="images/1170x400_1.jpg" alt="" /></div>
            <div><img src="images/1170x500.jpg" alt="" /></div>
            <div><img src="images/1170x300.jpg" alt="" /></div>
            <div><img src="images/1170x400_2.jpg" alt="" /></div>
          </div>
          <!-- end section -->
          ...
          <div class="divider_line10"></div>
          <div class="stcode_title4">
            <h3><span class="line"></span><span class="text"><strong>Lazy Load</strong><span></span></span></h3>
          </div>
          <div class="margin_top1"></div>
          <div class="clearfix"></div>
          <div id="owl-demo7" class="owl-carousel">
            <div class="item"><img class="lazyOwl" src="images/news1.jpg" alt="" /></div>
            <div class="item"><img class="lazyOwl" src="images/news2.jpg" alt="" /></div>
            <div class="item"><img class="lazyOwl" src="images/news3.jpg" alt="" /></div>
            <div class="item"><img class="lazyOwl" src="images/news4.jpg" alt="" /></div>
            <div class="item"><img class="lazyOwl" src="images/news5.jpg" alt="" /></div>
            <div class="item"><img class="lazyOwl" src="images/news6.jpg" alt="" /></div>
            <div class="item"><img class="lazyOwl" src="images/news1.jpg" alt="" /></div>
            <div class="item"><img class="lazyOwl" src="images/news2.jpg" alt="" /></div>
          </div>
          <!-- end section -->
          ...
          <div class="divider_line10"></div>
          <div class="stcode_title4">
            <h3><span class="line"></span><span class="text"><strong>Progress Bar</strong><span></span></span></h3>
          </div>
          <div class="margin_top1"></div>
          <div class="clearfix"></div>
          <div id="owl-demo9" class="owl-carousel">
            <div class="item"><img src="images/1170x400_5.jpg" alt="" /></div>
            <div class="item"><img src="images/1170x400_3.jpg" alt="" /></div>
            <div class="item"><img src="images/1170x400_4.jpg" alt="" /></div>
          </div>
          <!-- end section -->
          ...
          <div class="divider_line10"></div>
          <div class="stcode_title4">
            <h3><span class="line"></span><span class="text"><strong>Thumb Items</strong><span></span></span></h3>
          </div>
          <div class="margin_top1"></div>
          <div class="clearfix"></div>
          <div id="sync1" class="owl-carousel">
            <div class="item"><img src="images/1170x400_2.jpg" alt="" /></div>
            <div class="item"><img src="images/1170x400_3.jpg" alt="" /></div>
            <div class="item"><img src="images/1170x400_1.jpg" alt="" /></div>
            <div class="item"><img src="images/1170x400_4.jpg" alt="" /></div>
            <div class="item"><img src="images/1170x400_5.jpg" alt="" /></div>
            <div class="item"><img src="images/1170x400_3.jpg" alt="" /></div>
...
<!-- owl.carousel.min js --> 
<script type="text/javascript" src="js/cowl.carousel.js"></script> 
