      ...
      <div class="row">
        <div class="col-main col-sm-9">
          ...
          <div class="page-content checkout-page">
              ...
              <ul>
                ...
                <li class="row">
                  <div class="col-xs-12">
                    ...
                    <input type="text" class="input form-control" name="add" id="address">
                  </div>
                  <!--/ [col] --> 
                ...
                <li class="row">
                  <div class="col-sm-6">
                    ...
                    <input class="input form-control" type="text" name="pin code" id="postal_code">
                  </div>
                  <!--/ [col] -->
                  
                  <div  class="col-sm-6">
                    <label class="required">Country</label>
                    <select class="input form-control" name="con">
              ...
              <ul>
                <li class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input class="input form-control" type="text" name="last name" id="last_name_1">
                  </div>
                  <!--/ [col] --> 
                ...
                <li class="row">
                  <div class="col-sm-6">
                    ...
                    <input class="input form-control" type="text" name="company" id="company_name_1">
                  </div>
                  <!--/ [col] -->
                  
                  <div class="col-sm-6">
                    <label for="email_address_1" class="required">Email Address</label>
                    <input class="input form-control" type="text" name="add" id="email_address_1">
                  </div>
                  <!--/ [col] --> 
                ...
                <li class="row">
                  <div class="col-xs-12">
                    ...
                    <input class="input form-control" type="text" name="add" id="address_1">
                  </div>
                  <!--/ [col] --> 
                ...
                <li class="row">
                  <div class="col-sm-6">
                    ...
                    <input class="input form-control" type="text" name="PC" id="postal_code_1">
                  </div>
                  <!--/ [col] -->
            ...
            <h4 class="checkout-sep">6. Order Review</h4>
            <div class="box-border">
              <div class="table-responsive">
                <table class="table table-bordered cart_summary">
                  ...
                  <tbody>
                    <tr>
                      <td class="cart_product"><a href="#"><img src="images/img02.jpg" alt="Product"></a></td>
                    ...
                    <tr>
                      <td class="cart_product"><a href="#"><img src="images/img01.jpg" alt="Product"></a></td>
                      <td class="cart_description"><p class="product-name"><a href="#">Frederique Constant </a></p>
                        <small><a href="#">Color : Beige</a></small><br>
                        <small><a href="#">Size : S</a></small></td>
                      <td class="cart_avail"><span class="label label-success">In stock</span></td>
