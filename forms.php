      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Forms</strong></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="shortcodes-wrapper bounceInUp animated">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12">
          <h4>Inline Form</h4> <form class="form-inline">
            <div class="form-group">
        ...
        <div class="col-md-12">
          <h4>Horizontal form</h4> <form class="form-horizontal">
            <div class="form-group">
          ...
          <form action="#" class="form">
            ...
            <div class="form-group">
              <label class="checkbox checkbox-inline" for="checkbox5a">
                <input type="checkbox" data-toggle="checkbox" value="" id="checkbox5a" required checked>
                1 </label>
              <label class="checkbox checkbox-inline" for="checkbox5b">
                <input type="checkbox" data-toggle="checkbox" value="" id="checkbox5b" required >
                2 </label>
              <label class="checkbox checkbox-inline" for="checkbox5c">
                <input type="checkbox" data-toggle="checkbox" value="" id="checkbox5c" required >
                3 </label>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-12">
          <h4>Static control</h4> <form class="form-horizontal">
            <div class="form-group">
        ...
        <div class="col-md-12">
          <h4>Disabled fieldsets</h4> <form class="form-inline">
            <fieldset disabled>
              <div class="form-group">
              ...
              <label class="checkbox checkbox-inline" for="checkbox6">
                <input type="checkbox" data-toggle="checkbox" value="" id="checkbox6" required checked>
      ...
      <h6>Form group sizing</h6> <form class="form-horizontal">
      ...
      <div class="col-md-12">
        ...
        <h6>Sizing</h6>
        <div class="form-group">
          <div class="input-group input-group-hg"> <span class="input-group-addon">@</span>
      ...
      <div class="row">
        ...
        <div class="col-lg-6"> <h6>Segmented buttons</h6>
          <div class="form-group">
            <div class="input-group">
              <div class="input-group-btn">
