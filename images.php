      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Image Frames</strong></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="shortcodes-wrapper bounceInUp animated">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-4">
          <img src="images/blog-img3.jpg" alt="" class="imgframe1" />
          <!-- end section -->     
        </div>
      
        <div class="col-xs-4">
          <img src="images/blog-img2.jpg" alt="" class="imgframe2" />   
        </div>
        
        <!-- end section -->
        
        <div class="col-xs-4">
        <div class="imgframe3"><img src="images/blog-img1.jpg" alt="" /> <strong>Image Information</strong></div>
        </div>
        <!-- end section -->
          

          <div class="col-xs-6">
      <img src="images/projects-1.jpg" alt="" class="imgframe4" />
    
    </div>
   
       <div class="col-xs-6">
      <div class="imgframe5"><img src="images/projects-6.jpg" alt="" /></div>
    
    </div>

 <div class="col-xs-12">

    <div class="imgframe6"><img src="images/slider1.jpg" alt="" /></div><!-- end section -->
        </div>
      </div></div>
    </div>
    ...
    <div class="container">
       ...
       <h4> &nbsp;&nbsp; Default example</h4>
        ...
        <div class="col-xs-6 col-md-3">
          <a class="thumbnail" href="#">
            <img src="images/img01.jpg" alt="product">
          </a>
        </div>
        <div class="col-xs-6 col-md-3">
          <a class="thumbnail" href="#">
            <img src="images/img02.jpg" alt="product">
          </a>
        </div>
        <div class="col-xs-6 col-md-3">
          <a class="thumbnail" href="#">
            <img src="images/img03.jpg" alt="product">
          </a>
        </div>
        <div class="col-xs-6 col-md-3">
          <a class="thumbnail" href="#">
             <img src="images/img04.jpg" alt="product">
          </a>
        </div>
      ...
      <h4> &nbsp;&nbsp;Custom content</h4>
        <div class="col-sm-6 col-md-4">
          <div class="thumbnail">
             <img src="images/blog-img2.jpg" alt="product">
            <div class="caption">
        ...
        <div class="col-sm-6 col-md-4">
          <div class="thumbnail">
            <img src="images/blog-img3.jpg" alt="product">
            <div class="caption">
              <h3>Thumbnail label</h3>
              <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
              <p><a role="button" class="btn btn-primary" href="#">Button</a> <a role="button" class="btn btn-default" href="#">Button</a></p>
        ...
        <div class="col-sm-6 col-md-4">
          <div class="thumbnail">
            <img src="images/blog-img4.jpg" alt="product">
            <div class="caption">
              <h3>Thumbnail label</h3>
              <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
              <p><a role="button" class="btn btn-primary" href="#">Button</a> <a role="button" class="btn btn-default" href="#">Button</a></p>
      ...
      <h4> &nbsp;&nbsp;Images</h4>
      <div class="images_thum">
        <div class="col-sm-4">
        <img src="images/projects-2.jpg" alt="product" class="img-rounded"></div>
        <div class="col-sm-4">
        <img src="images/projects-1.jpg" alt="product" class="img-circle"></div>
        <div class="col-sm-4">
        <img src="images/projects-3.jpg" alt="product" class="img-thumbnail">
