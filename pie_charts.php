...
<div id="page"> 
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Pie Charts</strong></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="shortcodes-wrapper bounceInUp animated">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="one_full stcode_title6">
            <h2>With Diffrent Color of Charts</h2>
            <br />
          </div>
          <div class="piechart1">
    ...
    <div class="parallax_2 piechart">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <h2>With One Color of Charts</h2>
            <br />
          </div>
          <div class="piechart3">
            <canvas class="loader001"></canvas>
            <br />
            Photoshop </div>
          <div class="piechart3">
            <canvas class="loader002"></canvas>
            <br />
            HTML5 </div>
          <div class="piechart3">
            <canvas class="loader003"></canvas>
            <br />
            Javascript </div>
          <div class="piechart3">
            <canvas class="loader004"></canvas>
            <br />
            Wordpress </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 piechart_1">
          <h2>With Diffrent Size of Charts</h2>
          <br />
          <div class="piechart2 s1">
            <canvas class="loader01"></canvas>
          </div>
          <div class="piechart2 s2">
            <canvas class="loader02"></canvas>
          </div>
          <div class="piechart2 s3">
            <canvas class="loader03"></canvas>
          </div>
          <div class="piechart2 s4">
            <canvas class="loader04"></canvas>
          </div>
          <div class="piechart2">
            <canvas class="loader05"></canvas>
          </div>
          <div class="piechart2">
            <canvas class="loader06"></canvas>
          </div>
          <div class="piechart2">
            <canvas class="loader07"></canvas>
          </div>
        </div>
      </div>
    </div>
...
<script type="text/javascript" src="js/jquery.pie.charts.js"></script>
</body>
</html>