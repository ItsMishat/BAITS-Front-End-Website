...
<body class="portfolio-post_page">
<!-- mobile menu -->
<div id="mobile-menu">
  <ul>
      ...
      <div class="container">
        <div class="breadcrumbs">
          <ul>
            ...
            <li class=""> <a title="Go to Home Page" href="shop_grid.php">Elements</a><span>&raquo;</span></li>
            <li class="category13"><strong>Portfolio Details</strong></li>
          </ul>
        </div>
        <div class="portfolio-slid-info">
          <h1>Our Awesome Project Page</h1>
    ...
    <div class="container"> 
      ...
      <div class="row">
        <div class="portfolio_area">
          <div class="col-xs-9">
            <div class="portfolio_large-image"><a href="#" target="_blank"><img src="images/projects-details.jpg" alt="" /></a></div>
            <div class="inner-content">
              <p>Lorem ipsum dolor sit amet, proscriptum videt ulteriori. Filiam sunt amore nec est cum autem est se in. Cellam sanctissima coniunx in lucem exempli paupers coniunx rex cum autem quod ait regem Ardalio. Commendavi si mihi esse haec sed quod una in deinde duas formis!</p>
              <p>Lorem ipsum dolor sit amet, tollite fit manibus individuationis omnibus civitas ad quia. Quaere allocutus ait regem ut sua etiam quantitas non solutionem invenisti. Venis potest flens ibidem quod eam in. Ambo una litus vita Apolloni codicellos iam custodio vocem magno dies tuum abscondere. Venis potest meum in lucem concitaverunt in fuerat. Perveniunt felicibus oportebat eum est in fuerat construeret cena reges undis effugere quod eam eos Communicatio mihi! </p>
              <div class="one-fourth"> 
                <!-- COLUMN STARTS-->
                <p> Lorem ipsum dolor sit amet, tollite fit manibus individuationis omnibus civitas ad quia. Quaere allocutus ait regem ut sua etiam quantitas non solutionem invenisti. Venis potest flens ibidem quod eam in. Ambo una litus vita Apolloni codicellos iam custodio vocem magno dies tuum abscondere. </p>
                <p> Venis potest meum in lucem concitaverunt in fuerat. Perveniunt felicibus oportebat eum est in fuerat construeret cena reges undis effugere quod eam eos Communicatio mihi! </p>
              </div>
              <div class="one-fourth"> 
                <!-- COLUMN STARTS-->
                <p> Lorem ipsum dolor sit amet, tollite fit manibus individuationis omnibus civitas ad quia. Quaere allocutus ait regem ut sua etiam quantitas non solutionem invenisti. Venis potest flens ibidem quod eam in. Ambo una litus vita Apolloni codicellos iam custodio vocem magno dies tuum abscondere. </p>
              ...
              <div class="slider-items-products">
                <div id="related-posts" class="product-flexslider hidden-buttons">
                  <div class="slider-items slider-width-col4 fadeInUp">
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="images/projects-1.jpg" alt="projects-1"> </a> </div>
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="images/projects-3.jpg" alt="Blog"> </a> </div>
                        <div class="entry-info">
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="images/projects-4.jpg" alt="Blog"> </a> </div>
                        <div class="entry-info">
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="images/projects-5.jpg" alt="Blog"> </a> </div>
                        <div class="entry-info">
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="images/projects-6.jpg" alt="Blog"> </a> </div>
                        <div class="entry-info">
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="images/projects-7.jpg" alt="Blog"> </a> </div>
                        <div class="entry-info">
                    ...
                    <div class="product-item">
                      <article class="entry">
                        <div class="entry-thumb image-hover2"> <a href="#"> <img src="images/projects-10.jpg" alt="Blog"> </a> </div>
                        <div class="entry-info">
          ...
          <aside class="col-xs-3 right sidebar">
            <div class="block blog-module">
              <div class="sidebar-title">
                <p class="title_block">Project Description</p>
              </div>
              <div class="block_content">
                <p>Lorem ipsum dolor sit amet, stranguillionem in modo. Dionysiade conspectu ab adulescentiae discesserunt manu duas recitare.</p>
                <a href="#" class="addto_favorites"><i class="fa fa-heart"></i>&nbsp; Add to Favorites</a>
                <div class="project_details">
                  <h5>Project Details</h5>
                  <b>Client's Web Adress</b> <a href="#">www.abc.com</a> <span class="date"><strong>Date</strong> <em>10 jan 2016</em></span> <span><strong>Categories</strong> <em><a href="#">Clothing</a> <a href="#">Accessories</a> <a href="#">Food</a> <a href="#">Other</a> </em></span> <span class="author"><strong>Author</strong> <em>Jone Doe</em></span> <a href="#" class="readMore"><i class="fa fa-hand-o-right fa-lg"></i>&nbsp; Visit Site</a> </div>
              </div>
            </div>
...
<script type="text/javascript" src="js/portfolio-2.js"></script>
</body>
</html>
