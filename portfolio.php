      ...
      <div class="container">
        <div class="breadcrumbs">
          <ul>
            ...
            <li class="category13"><strong>Portfolio Columns 1</strong></li>
          </ul>
        </div>
        <div class="portfolio-slid-info">
          <h1>Portfolio Standard one Columns</h1>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div id="filters-container" class="portfolio-filters-button">
            <div data-filter="*" class="mt-filter-item-active mt-filter-item"> All works
              <div class="mt-filter-counter"></div>
            </div>
            <div data-filter=".clothing" class="mt-filter-item"> Clothing
              <div class="mt-filter-counter"></div>
            </div>
          ...
          <div id="grid-container" class="one-col">
            <div class="mt-item clothing other">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-1.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
              <div class="portfolio-caption-alignCenter">
                <div class="portfolio-caption-body">
                  ...
                  <a href="portfolio-post.php" class="learn-more">Learn More</a> </div>
              </div>
            </div>
            <!-- end item -->
            <div class="mt-item accessories">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-3.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item clothing">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-2.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item accessories">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-4.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item food">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-8.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-5.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item food accessories">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-6.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item accessories">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-10.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item food">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-7.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item accessories">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-11.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item food">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-12.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
            ...
            <div class="mt-item clothing">
              <div class="mt-caption">
                <div class="mt-caption-defaultWrap"> <img src="images/projects-9.jpg" alt=""> </div>
                <div class="mt-caption-activeWrap">
                  <div class="mt-search"> <a href="portfolio-post.php"> <i class="fa fa-search"></i> </a> </div>
                </div>
              </div>
...
<script type="text/javascript" src="js/portfolio-1.js"></script>
</body>
</html>
