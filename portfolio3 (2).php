      ...
      <div class="container">
        <div class="breadcrumbs">
          <ul>
            ...
            <li class="category13"><strong>Portfolio Columns 3</strong></li>
          </ul>
        </div>
        <div class="portfolio-slid-info">
          <h1>Portfolio Standard Three Columns</h1>
...
<script type="text/javascript" src="js/portfolio-3.js"></script>
</body>
</html>
