              ...
              <div class="inner-cl">
                <div class="block block-language form-language">
                  ...
                  <ul>
                    ...
                    <li> <a href="#"> <img src="images/francais.jpg" alt="flag"> <span>French</span> </a> </li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Pricing Table</strong></li>
          </ul>
        </div>
      </div>
    </div>
...
<br>
            ...
            <div class="pricing-table-box container">
            <div class="row price-table-row">
                        <div class="heading-title text-center">
                            <h3>Pricing Table - 4 Column </h3>
                        </div><br>
                        <div class=" ">
                            <!--4 column price table-->
                            <div class="col-md-3">
                                <div class="price-col"> <h2>Starter</h2>
                                    <div class="p-value">
                                        <div class="dollar">
            ...
            <hr/><br>
            <div class="pricing-table-box actions container">
            <div class="row price-table-row">
                        <div class="heading-title text-center">
                            <h3>Pricing Table - 3 Column without gap</h3>
                        </div><br>
   ...
   <div class="page-content price-table-parallax">
                <div class="container">
                    <div class="row price-table-row">
                        <div class=" ">
                            <!--3 column price table-->
