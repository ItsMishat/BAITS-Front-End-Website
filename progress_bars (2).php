      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Progress Bars</strong></li>
          </ul>
        </div>
      </div>
    </div>
...
<section class="shortcodes-wrapper bounceInUp animated">
  <div class="container">
    <div class="row">
     ...
     <div class="col-sm-6 col-xs-12 progr_bar1">  <div class="pro_bar">
            ...
            <div class="ui-progress five"><span class="ui-label"><b class="value">85%</b></span></div>
            </div><!-- end section -->
            
		</div></div>   
 
        
         <div class="col-sm-6 col-xs-12 progr_bar2"><div class="pro_bar">
    	
            <h5>Website Design</h5>
            <div id="progress_bar_gray001" class="ui-progress-bar4 ui-container">
            <div class="ui-progress4"><span class="ui-label"><b class="value">90%</b></span></div>
            </div><!-- end section -->
            
            <br />
            
            <h5>Graphic Design</h5>
            <div id="progress_bar_gray002" class="ui-progress-bar4 ui-container">
            <div class="ui-progress4"><span class="ui-label"><b class="value">72%</b></span></div>
            </div><!-- end section -->
            
            <br />
            
            <h5>Javascript</h5>
            <div id="progress_bar_gray003" class="ui-progress-bar4 ui-container">
            <div class="ui-progress4"><span class="ui-label"><b class="value">80%</b></span></div>
            </div><!-- end section -->
            
            <br />
            
            <h5>Photoshop</h5>
            <div id="progress_bar_gray004" class="ui-progress-bar4 ui-container">
            <div class="ui-progress4"><span class="ui-label"><b class="value">94%</b></span></div>
            </div><!-- end section -->
        	
            <br />
            
            <h5>HTML5 & CCS3</h5>
            <div id="progress_bar_gray005" class="ui-progress-bar4 ui-container">
            <div class="ui-progress4"><span class="ui-label"><b class="value">85%</b></span></div>
            </div><!-- end section -->
  ...
  <div class="parallax_2 progr_bar">
      <div class="container">
        <div class="row">
        <div class="col-sm-6 col-xs-12"> <img src="images/about_us_slide2.jpg" alt=""/> </div>
          <div class="col-sm-6 col-xs-12">
            <div class="pro_bar">
    	            
            <h5>Website Design</h5>
            <div id="progress_bar001" class="ui-progress-bar2 ui-container">
            <div class="ui-progress2"><span class="ui-label"><b class="value">90%</b></span></div>
            </div><!-- end section -->
            
            <br />
            
            <h5>Graphic Design</h5>
            <div id="progress_bar002" class="ui-progress-bar2 ui-container">
            <div class="ui-progress2 two"><span class="ui-label"><b class="value">72%</b></span></div>
            </div><!-- end section -->
            
            <br />
            
            <h5>Javascript</h5>
            <div id="progress_bar003" class="ui-progress-bar2 ui-container">
            <div class="ui-progress2 three"><span class="ui-label"><b class="value">80%</b></span></div>
            </div><!-- end section -->
            
            <br />
            
            <h5>Photoshop</h5>
            <div id="progress_bar004" class="ui-progress-bar2 ui-container">
            <div class="ui-progress2 four"><span class="ui-label"><b class="value">94%</b></span></div>
            </div><!-- end section -->
        	
            <br />
            
            <h5>HTML5 & CCS3</h5>
            <div id="progress_bar005" class="ui-progress-bar2 ui-container">
            <div class="ui-progress2 five"><span class="ui-label"><b class="value">94%</b></span></div>
            </div><!-- end section -->
...
<div class="parallax_1">
      <div class="container">
        ...
        <div class="col-sm-6 col-xs-12 progr_bar3">
            <div class="pro_bar">
    	
            <h5>Website Design</h5>
            <div id="progress_bar_gray" class="ui-progress-bar3 ui-container">
            <div class="ui-progress3"><span class="ui-label"><b class="value">90%</b></span></div>
            </div><!-- end section -->
            ...
            <div class="ui-progress3"><span class="ui-label"><b class="value">72%</b></span></div>
            </div><!-- end section -->
            ...
            <div class="ui-progress3"><span class="ui-label"><b class="value">80%</b></span></div>
            </div><!-- end section -->
            ...
            <div class="ui-progress3"><span class="ui-label"><b class="value">94%</b></span></div>
            </div><!-- end section -->
            ...
            <div class="ui-progress3"><span class="ui-label"><b class="value">85%</b></span></div>
            </div><!-- end section -->
            
		</div>
          </div>
          
        <div class="col-sm-6 col-xs-12"> <img src="images/about_us_slide1.jpg" alt=""/> </div>
