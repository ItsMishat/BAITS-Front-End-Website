        ...
        <div class="col-main col-sm-9">
          <div class="product-view-area">
            <div class="product-big-image col-xs-12 col-sm-9 col-lg-5 col-md-5">
              <div class="icon-sale-label sale-left">Sale</div>
              <div class="large-image"> <a href="images/img01.jpg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img class="zoom-img" src="images/img01.jpg" alt="products"> </a> </div>
              <div class="flexslider flexslider-thumb">
                <ul class="previews-list slides">
                  <li><a href='images/img01.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/img01.jpg' "><img src="images/img01.jpg" alt = "Thumbnail 2"/></a></li>
                  <li><a href='images/img07.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/img07.jpg' "><img src="images/img07.jpg" alt = "Thumbnail 1"/></a></li>
                  <li><a href='images/img02.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/img02.jpg' "><img src="images/img02.jpg" alt = "Thumbnail 1"/></a></li>
                  <li><a href='images/img03.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/img03.jpg' "><img src="images/img03.jpg" alt = "Thumbnail 2"/></a></li>
                  <li><a href='images/img04.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/img04.jpg' "><img src="images/img04.jpg" alt = "Thumbnail 2"/></a></li>
                </ul>
              </div>
            ...
            <div id="upsell-product-slider" class="product-flexslider hidden-buttons">
              <div class="slider-items slider-width-col4">
                ...
                <div class="product-item">
                  <div class="item-inner fadeInUp">
                    <div class="product-thumbnail">
                      <div class="pr-img-area"> <img class="first-img" src="images/img02.jpg" alt=""> <img class="hover-img" src="images/img02.jpg" alt="">
                        <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                      </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
                ...
                <div class="product-item">
                  <div class="item-inner fadeInUp">
                    <div class="product-thumbnail">
                      <div class="pr-img-area"> <img class="first-img" src="images/img03.jpg" alt=""> <img class="hover-img" src="images/img03.jpg" alt="">
                        <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                      </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
                ...
                <div class="product-item">
                  <div class="item-inner fadeInUp">
                    ...
                    <div class="icon-new-label new-right">New</div>
                    <div class="product-thumbnail">
                      <div class="pr-img-area"> <img class="first-img" src="images/img04.jpg" alt=""> <img class="hover-img" src="images/img04.jpg" alt="">
                        <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                      </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
                ...
                <div class="product-item">
                  <div class="item-inner fadeInUp">
                    <div class="product-thumbnail">
                      ...
                      <div class="pr-img-area"> <img class="first-img" src="images/img05.jpg" alt=""> <img class="hover-img" src="images/img05.jpg" alt="">
                        <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                      </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
                ...
                <div class="product-item">
                  <div class="item-inner fadeInUp">
                    <div class="product-thumbnail">
                      <div class="pr-img-area"> <img class="first-img" src="images/img06.jpg" alt=""> <img class="hover-img" src="images/img06.jpg" alt="">
                        <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                      </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
