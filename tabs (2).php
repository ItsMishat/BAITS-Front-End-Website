...
<div id="page"> 
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Tabs</strong></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="shortcodes-wrapper bounceInUp animated">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <ul class="tabs3">
            ...
            <li><a href="#example-3-tab-2" target="_self">Jquery</a></li>
            <li><a href="#example-3-tab-3" target="_self">HTML5 </a></li>
            <li><a href="#example-3-tab-4" target="_self">CSS3</a></li>
          </ul>
          <div class="tabs-content3 two">
            <div id="example-3-tab-1" class="tabs-panel3">
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation adipisicing elit incididunt ad minim veniam ipsum dolor.</p>
              <p>Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. sed diam nonummy nibh euismod tincidunt.</p>
            </div>
            <!-- end tab 1 -->
            ...
            <div id="example-3-tab-2" class="tabs-panel3">
              ...
              <p>Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus.</p>
            </div>
            <!-- end tab 2 -->
            
            <div id="example-3-tab-3" class="tabs-panel3">
              <p>Mauris vel tellus non nunc mattis lobortis.Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. </p>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation adipisicing elit incididunt ad minim veniam ipsum dolor.</p>
              <p>Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. sed diam nonummy nibh euismod tincidunt.</p>
            </div>
            <!-- end tab 3 -->
          ...
          <div class="col-xs-12">
          <ul class="tabs side"><li><a href="#demo-tab-1" target="_self"><i class="fa fa-html5"></i> HTML5</a></li>
            <li><a href="#demo-tab-2" target="_self"><i class="fa fa-desktop"></i> Web Design</a></li>            
            <li><a href="#demo-tab-3" target="_self"><i class="fa fa-css3"></i> CSS3</a></li>
          </ul>
          <div class="tabs-content">
            <div id="demo-tab-1" class="tabs-panel ">
              <h1><strong>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</strong></h1>
              <h4 class="grayc"> Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</h4>
          
               <p> Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.</p>
              <p>Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. sed diam nonummy nibh euismod tincidunt.</p>
                  <ul class="list2">
                <li><i class="fa fa-angle-double-right"></i> Nulla luctus malesuada tincidunt. Class aptent taciti.</li>
                <li><i class="fa fa-angle-double-right"></i> Vestibulum ante ipsum primis in faucibus orci luctus.</li>
                <li><i class="fa fa-angle-double-right"></i> Lorem ipsum dolor sit amet, consectetur adipisicing.</li>
                 <li><i class="fa fa-angle-double-right"></i> Quisque in arcu id dui vulputate mollis eget non arcu.</li>
              </ul>
        ...
        <h1><strong>Sunt ut voluptatum eius sapiente, totam reiciendis temporibus</strong></h1>
              <h4 class="grayc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</h4>
    ...
    <h1><strong>Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus</strong></h1>
              <h4 class="grayc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</h4>
          ...
          <div class="col-xs-12">
          <ul class="tabs2">
            <li><a href="#example-2-tab-1" target="_self">HTML5</a></li>
            <li><a href="#example-2-tab-2" target="_self">CSS3</a></li>
            <li><a href="#example-2-tab-3" target="_self">Jquery</a></li>
          </ul>
          <div class="tabs-content2 fullw">
            ...
            <div id="example-2-tab-3" class="tabs-panel2">
              <p>Financial dolor sit consectetur adipiscing elit. Phasellus ac fringilla nulla, sit amet consequat eros. Pellentesque pharetra blandit commodo. Phasellus massa nisl, feugiat ac bibendum et, dictum id ipsum. Quisque sit amet accumsan tortor. Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words.</p>
            </div>
            <!-- end tab 3 --> 
