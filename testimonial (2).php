        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-6 language-currency-wrapper">
              <div class="inner-cl">
                <div class="block block-language form-language">
                  ...
                  <ul>
                    ...
                    <li> <a href="#"> <img src="images/flag-french.jpg" alt="flag"> <span>French</span> </a> </li>
              ...
              <!-- CEO, XYZ Softwearault Welcome Message -->
              <div class="welcome-msg hidden-xs">CEO, XYZ Softwearault welcome msg! </div>
              <!-- End CEO, XYZ Softwearault Welcome Message --> 
            </div>
            <!-- top links -->
                  ...
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      ...
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="images/img01.jpg" alt=""> <img class="hover-img" src="images/img01.jpg" alt="">
                ...
                <li class="menu-item depth-1 product menucol-1-4 withimage">
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      <div class="icon-sale-label sale-left">Sale</div>
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="images/img18.jpg" alt=""> <img class="hover-img" src="images/img18.jpg" alt="">
                          <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                ...
                <li class="menu-item depth-1 product menucol-1-4 withimage">
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      ...
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="images/img19.jpg" alt=""> <img class="hover-img" src="images/img19.jpg" alt="">
                          <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                ...
                <li class="menu-item depth-1 product menucol-1-4 withimage">
                  <div class="product-item">
                    <div class="item-inner fadeInUp">
                      ...
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <img class="first-img" src="images/img20.jpg" alt=""> <img class="hover-img" src="images/img20.jpg" alt="">
                          <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                        </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category13"><strong>Testimonial</strong></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <ul class="testimonial plus-box grid-2 ">
            <li>
              <div class="avatar"> <a href="#"><img src="images/t1.jpg" alt="Customer Testimonails"></a> </div>
              <div class="content">
                ...
                <div class="testimonial-meta"> Josefine <span>CEO,XYZ Softwear</span> </div>
              </div>
            </li>
            <li>
              <div class="avatar"> <a href="#"><img src="images/t2.jpg" alt="Customer Testimonails"></a> </div>
              <div class="content">
                <p>Vestibulum varius fermentum risus vitae lacinia neque auctor nec. Nunc ac rutrum nulla. Nulla maximus dolor in quam euismod ac viverra libero aliquet. </p>
                <div class="testimonial-meta"> Paulo Moreira <span>CEO,ABC Softwear</span> </div>
              </div>
            </li>
            <li>
              <div class="avatar"> <a href="#"><img src="images/t3.jpg" alt="Customer Testimonails"></a> </div>
              <div class="content">
                <p>Vestibulum varius fermentum risus vitae lacinia neque auctor nec. Nunc ac rutrum nulla. Nulla maximus dolor in quam euismod ac viverra libero aliquet. </p>
                <div class="testimonial-meta"> Tom Joana <span>CEO,LMN Softwear</span> </div>
              </div>
            </li>
            <li>
              <div class="avatar"> <a href="#"><img src="images/t4.jpg" alt="Customer Testimonails"></a> </div>
              <div class="content">
                <p>Vestibulum varius fermentum risus vitae lacinia neque auctor nec. Nunc ac rutrum nulla. Nulla maximus dolor in quam euismod ac viverra libero aliquet. </p>
                <div class="testimonial-meta"> John Doe <span>head of marketing, TB</span> </div>
              </div>
            </li>
          </ul>
          <!--testimonial end--> 
        ...
        <div class="col-md-12"> 
          ...
          <div id="testimonial-2" class="outer-border">
            <div class="item">
              ...
              <div class="content">
                <p> Lorem ipsum dolor sit amet set, consectetur utes anet adipisicing elit, sed do eiusmod tempor incidist. Aliquam varius dolor nunc, interdum commodo justoporttitor vitae.
                  Quisque fermentum purus. </p>
                <div class="testimonial-meta"> - Vince Roy - <span>CEO, XYZ Softwear</span> </div>
              </div>
            </div>
            <div class="item">
              <div class="icon"> <i class="fa fa-quote-left"></i> </div>
            ...
            <div class="item">
              ...
              <div class="content">
                <p>Vestibulum varius fermentum risus vitae lacinia neque auctor nec. Nunc ac rutrum nulla. Nulla maximus dolor in quam euismod ac viverra libero aliquet. </p>
                <div class="testimonial-meta"> - Linda Smith - <span>CEO,LMN Softwear</span> </div>
              </div>
            </div>
          </div>
          <!--testimonial end--> 
        ...
        <div class="row">
          <div class="col-md-12"> 
            ...
            <div id="testimonial-3" class="text-center light-txt big-icon ">
              <div class="item">
                <div class="icon theme-color"> <i class="icon-user_comment"></i> </div>
                <div class="content">
                  <p> Lorem ipsum dolor sit amet set, consectetur utes anet adipisicing elit, sed do eiusmod tempor incidist. Aliquam varius dolor nunc, interdum commodo justoporttitor vitae.
                    Quisque fermentum purus. </p>
                  <div class="testimonial-meta"> - Vince Roy - <span>CEO, XYZ Softwear</span> </div>
              ...
              <div class="item">
                <div class="icon theme-color"> <i class="icon-user"></i> </div>
                <div class="content">
                  <p>Vestibulum varius fermentum risus vitae lacinia neque auctor nec. Nunc ac rutrum nulla. Nulla maximus dolor in quam euismod ac viverra libero aliquet. </p>
                  <div class="testimonial-meta"> - John Doe - <span>head of marketing, TB</span> </div>
                </div>
        ...
        <div id="testimonial-4" class="testimonial-alt">
          <div class="item">
            ...
            <div class="testi-auth">
              <div class="avatar"> <a href="#"><img src="images/1.jpg" alt="Customer Testimonails"></a> </div>
              <div class="testimonial-meta"> Vince Roy <span>CEO, XYZ Softwear</span> </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="testi-auth">
              <div class="avatar"> <a href="#"><img src="images/2.jpg" alt="Customer Testimonails"></a> </div>
              <div class="testimonial-meta"> John Doe <span>CEO, XYZ Softwear</span> </div>
            </div>
          </div>
          <div class="item">
            <div class="content">
            ...
            <div class="testi-auth">
              <div class="avatar"> <a href="#"><img src="images/3.jpg" alt="Customer Testimonails"></a> </div>
              <div class="testimonial-meta"> Tom Joana <span>CEO,EFG Softwear</span> </div>
            </div>
          </div>
        </div>
        <!--testimonial end--> 
          ...
          <div class="row">
            <div class="col-md-12"> 
              ...
              <div id="testimonial-5" class="text-center light-txt big-icon ">
                <div class="item">
                  <div class="testimonial-thumb"> <img class="img-circle" src="images/1.jpg" alt=""> </div>
                  <div class="content">
                    <p class="half-txt"> Lorem ipsum dolor sit amet set, consectetur utes anet adipisicing elit, sed do eiusmod tempor incidist. Aliquam varius dolor nunc, interdum commodo justoporttitor vitae.
                      Quisque fermentum purus. </p>
                    <div class="testimonial-meta"> - Vince Roy - <span>CEO, XYZ Softwear</span> </div>
                  </div>
                </div>
                <div class="item">
                  <div class="testimonial-thumb"> <img class="img-circle" src="images/2.jpg" alt=""> </div>
                  <div class="content">
                    <p class="half-txt">Vestibulum varius fermentum risus vitae lacinia neque auctor nec. Nunc ac rutrum nulla. Nulla maximus dolor in quam euismod ac viverra libero aliquet. </p>
                    <div class="testimonial-meta"> - John Doe - <span>head of marketing, TB</span> </div>
                  </div>
                </div>
                <div class="item">
                  <div class="testimonial-thumb"> <img class="img-circle" src="images/3.jpg" alt=""> </div>
                  <div class="content">
                    <p class="half-txt">Vestibulum varius fermentum risus vitae lacinia neque auctor nec. Nunc ac rutrum nulla. Nulla maximus dolor in quam euismod ac viverra libero aliquet. </p>
                    <div class="testimonial-meta"> - Linda Smith - <span>CEO,LMN Softwear</span> </div>
                  </div>
