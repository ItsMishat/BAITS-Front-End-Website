          ...
          <div class="my-account">
            ...
            <div class="my-wishlist">
              <div class="box-border box-wishlist">
                ...
                <button class="button"><span>Save Wishlist</span></button>
              </div>
              ...
              <ul class="row list-wishlist">
                <li class="col-sm-6 col-md-4 col-lg-3">
                  <div class="item"> <a class="close-wishlist" href="#"><i class="fa fa-close"></i></a>
                    <div class="product-img"> <a href="#"><img src="images/img01.jpg" alt="Product"></a> </div>
                    <div class="item-info">
                      <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.php">Ipsums Dolors Untra </a> </div>
                      <div class="qty">
                        <label>Qty:</label>
                      ...
                      <div class="button-action">
                        <button class="button button-sm"><span>Save</span></button>
                      </div>
                    </div>
                  </div>
                </li>
                <li class="col-sm-6 col-md-4 col-lg-3">
                  <div class="item"> <a class="close-wishlist" href="#"><i class="fa fa-close"></i></a>
                    <div class="product-img"> <a href="#"><img src="images/img02.jpg" alt="Product"></a> </div>
                    <div class="item-info">
                      <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.php">Ipsums Dolors Untra </a> </div>
                      <div class="qty">
                        <label>Qty:</label>
                ...
                <li class="col-sm-6 col-md-4 col-lg-3">
                  <div class="item"> <a class="close-wishlist" href="#"><i class="fa fa-close"></i></a>
                    <div class="product-img"> <a href="#"><img src="images/img03.jpg" alt="Product"></a> </div>
                    <div class="item-info">
                      <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.php">Ipsums Dolors Untra </a> </div>
                      <div class="qty">
                        <label>Qty:</label>
                ...
                <li class="col-sm-6 col-md-4 col-lg-3">
                  <div class="item"> <a class="close-wishlist" href="#"><i class="fa fa-close"></i></a>
                    <div class="product-img"> <a href="#"><img src="images/img04.jpg" alt="Product"></a> </div>
                    <div class="item-info">
                      <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.php">Ipsums Dolors Untra </a> </div>
                      <div class="qty">
                        <label>Qty:</label>
                ...
                <li class="col-sm-6 col-md-4 col-lg-3">
                  <div class="item"> <a class="close-wishlist" href="#"><i class="fa fa-close"></i></a>
                    <div class="product-img"> <a href="#"><img src="images/img05.jpg" alt="Product"></a> </div>
                    <div class="item-info">
                      <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.php">Ipsums Dolors Untra </a> </div>
                      <div class="qty">
                        <label>Qty:</label>
                ...
                <li class="col-sm-6 col-md-4 col-lg-3">
                  <div class="item"> <a class="close-wishlist" href="#"><i class="fa fa-close"></i></a>
                    <div class="product-img"> <a href="#"><img src="images/img06.jpg" alt="Product"></a> </div>
                    <div class="item-info">
                      <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.php">Ipsums Dolors Untra </a> </div>
                      <div class="qty">
                        <label>Qty:</label>
                ...
                <li class="col-sm-6 col-md-4 col-lg-3">
                  <div class="item"> <a class="close-wishlist" href="#"><i class="fa fa-close"></i></a>
                    <div class="product-img"> <a href="#"><img src="images/img07.jpg" alt="Product"></a> </div>
                    <div class="item-info">
                      <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.php">Ipsums Dolors Untra </a> </div>
                      <div class="qty">
                        <label>Qty:</label>
                ...
                <li class="col-sm-6 col-md-4 col-lg-3">
                  <div class="item"> <a class="close-wishlist" href="#"><i class="fa fa-close"></i></a>
                    <div class="product-img"> <a href="#"><img src="images/img08.jpg" alt="Product"></a> </div>
                    <div class="item-info">
                      <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.php">Ipsums Dolors Untra </a> </div>
                      <div class="qty">
                        <label>Qty:</label>
